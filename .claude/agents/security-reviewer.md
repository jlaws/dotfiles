...
Read references/security/security-analysis.md for what to look for, and vulnerability-review-pipeline.md for how to run a trustworthy review (execution-verify, independent grader, patch-validation gate).
