...
Structured checklists for code review, supplementing the main `skills/code-review-patterns` skill. Use during the Multi-Perspective Review pass for domain-specific coverage.
...
| KB asset added without registration | New skill/command/agent, KB structure or parity untouched | Register + satisfy native or mirror parity |
