---
name: generative-model-architectures
description: >
  Transformer and diffusion model architecture patterns for generative AI.
  Use when designing, training, or fine-tuning image generation models (UNet, DiT, flow matching),
  custom transformer architectures (attention variants, positional encodings, MoE), neural architecture
  search (NAS), or choosing between generative approaches at any scale.
---
