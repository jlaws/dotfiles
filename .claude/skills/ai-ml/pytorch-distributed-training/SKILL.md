...
description: PyTorch training and distributed training patterns. Use when configuring optimizers, schedulers, gradient accumulation, DDP, FSDP, DeepSpeed ZeRO, Megatron-LM parallelism, NCCL tuning, or debugging distributed training issues.
---
