...
description: "End-to-end LLM training: pretraining data/compute planning, LoRA/QLoRA/PEFT fine-tuning, adapter merging, and eval loops. Use when planning or implementing any LLM training workflow -- from scratch pretraining through supervised fine-tuning."
---
