...
description: >
  Design data platforms spanning lakehouse storage, quality validation, and feature serving.
  Use when choosing table formats (Iceberg/Delta/Hudi), building data quality pipelines
  (Great Expectations, dbt tests, data contracts), or designing ML feature stores
  (Feast, online/offline serving, point-in-time correctness).
---
