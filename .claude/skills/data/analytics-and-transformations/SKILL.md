---
name: analytics-and-transformations
description: dbt modeling, SQL optimization, indexing, and query performance. Use when building dbt transformations, debugging slow queries, choosing materialization strategies, or optimizing SQL performance.
---
