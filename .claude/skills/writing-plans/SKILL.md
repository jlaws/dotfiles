...
- **Decisions persisted** — every significant, not-easily-reversible decision has an ADR task (`docs/adr/<topic>/<slug>.md`); minor ones are noted inline. See `.claude/references/architecture/architecture-decision-records.md`.
