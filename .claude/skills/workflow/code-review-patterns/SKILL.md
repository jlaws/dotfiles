...
For large diffs (>500 lines) or when invoked via `/team-review`. See [references/team-review-config.md](references/team-review-config.md) for team configuration and workflow.
