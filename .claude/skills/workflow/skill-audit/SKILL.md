---
name: skill-audit
description: "Audit skills for conformance to Anthropic's skill-building standards — structural, frontmatter, and content quality checks with phased report. Use when validating skill compliance, checking naming conventions, or verifying skill quality after creation or modification. Do NOT use for general code quality checks (use code-quality) or code review workflows (use code-review-patterns)."
...
Audit skills under `.claude/skills/` for conformance to Anthropic's skill-building standards.
