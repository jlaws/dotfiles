---
name: cmd-research-email-analysis
...
1. **Parse input**: The user's input is the file path to the email body (read the file to extract content).
...
Apply the above methodology to produce the structured output for the email file specified by the user.
