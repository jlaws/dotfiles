...
Read `.cursor/references/frontend/premium-design-aesthetics` and `.cursor/references/frontend/design-system-patterns` before producing recommendations (if available).
