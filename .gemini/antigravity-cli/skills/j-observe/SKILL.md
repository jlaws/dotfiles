...
For deep observability design, you may delegate to the `devops-engineer` agent (it loads the `references/devops/` library incl. observability, sre-practices, incident-management). Verify its output before presenting.
