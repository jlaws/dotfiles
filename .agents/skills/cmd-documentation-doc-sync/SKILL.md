---
name: cmd-documentation-doc-sync
description: "Post-ship documentation sync — discover and fix stale docs after shipping changes. Use when docs may be out of date after a release or feature merge. Do NOT use for writing new docs from scratch (use /cmd-documentation-docs instead)."
disable-model-invocation: true
---

# Documentation Sync

Sync documentation with recent code changes based on the user's provided input.

---

## Step 1 — Determine Scope

Parse the user's input for a git range. Defaults:
- No input: last tag..HEAD (use `git describe --tags --abbrev=0`)
