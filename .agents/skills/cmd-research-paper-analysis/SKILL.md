---
name: cmd-research-paper-analysis
...
Pass all discovered resources when populating the Resources & Links section.
...
Apply the above methodology to analyze the paper specified by the user.
