---
name: cmd-data-data
description: "Data engineering consultation — data pipelines, query optimization, and data platform design. Use when building data pipelines, optimizing queries, or designing data platforms. Do NOT use for basic SQL questions (search references for quick help)."
