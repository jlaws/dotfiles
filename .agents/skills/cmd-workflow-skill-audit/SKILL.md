...
description: "Audit the .agents/ knowledge base — skills, references, and cross-references for conformance and integrity. Use when creating or modifying any .agents/ asset to validate compliance. Do NOT use for quick checks (inspect files directly instead)."
