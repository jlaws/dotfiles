...
4. **Get scope overview** of the target area (if the user's provided input specifies a component, scope to that; otherwise scan for src/components/, pages/, app/, or similar directories).
