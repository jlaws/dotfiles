...
Reference for Codex hook configuration patterns. Hooks run shell commands at specific lifecycle points, enabling automated validation, formatting, and guardrails.
...
Hook scripts in this repo live under `.codex/hooks/` and are synced to `~/.codex/hooks/`.
