...
- .codex/references/ai-ml/ml-model-deployment.md -- deployment patterns and serving infrastructure
- .codex/references/ai-ml/ml-experiment-lifecycle.md -- experiment tracking and model registry
- .codex/references/ai-ml/llmops-production-monitoring.md -- production monitoring for ML systems
