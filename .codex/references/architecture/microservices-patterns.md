...
- .codex/references/cloud/multi-cloud-architecture.md -- multi-cloud deployment strategies
- .codex/references/data/streaming-data-processing.md -- event streaming for microservices
