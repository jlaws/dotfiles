---
name: doc-sync
description: "Post-ship documentation sync — discover and fix stale docs after shipping changes. Use when docs may be out of date after a release or feature merge. Do NOT use for writing new docs from scratch (use /docs instead)."
...
Search for: README*, ARCHITECTURE*, CONTRIBUTING*, AGENTS.md, CHANGELOG*, docs/*.md, root *.md files.
