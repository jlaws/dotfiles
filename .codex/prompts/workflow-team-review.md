---
name: workflow-team-review
description: "Thorough code review — specialist perspectives for security, quality, testing, and language-specific analysis. Use when you want thorough multi-perspective review of a feature branch. Do NOT use on main/master (fail fast)."
argument-hint: "<branch-or-diff-scope>"
---

Use the code review methodology below:
