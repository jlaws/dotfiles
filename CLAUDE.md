...
2. **Installs Homebrew packages**: coreutils, findutils, fd, gnu-sed, moreutils, vim, grep, openssh, screen, wget, git, git-lfs, gh, autojump, mermaid-cli, poppler, node, pyright, rust-analyzer
